...
if __name__ == '__main__':
    ...
    parser.add_argument('--img-path',default="./val_test/", type=str)
    parser.add_argument('--input-size', type=int, default=518)
    parser.add_argument('--outdir', type=str, default='./val_test_compare/all')

    parser.add_argument('--encoder', type=str, default='vitb', choices=['vits', 'vitb', 'vitl', 'vitg'])
    parser.add_argument('--load-from', type=str, default="./results/all/latest_model.pth")
    ...
    depth_anything = DepthAnythingV2(**{**model_configs[args.encoder], 'max_depth': args.max_depth, 'lora_type': args.lora_type})
